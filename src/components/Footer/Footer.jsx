    ...
    return (
        <>
            ...
            <section className=' bg-base-200 '>
                <footer className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-10 mt-24 max-w-6xl mx-auto space-y-8">
                    <aside>
                    ...
                    <nav className='md:mt-8 leading-7 tracking-wide'>
